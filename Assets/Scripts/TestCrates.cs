...
public class TestCrates : MonoBehaviour
{
    ...
    public List<string> listMisteryPower = new List<string>(){"SpeedUp","SpeedDown","ArmorUp","ArmorDown","AttackUp","AttackDown","HealthUp","HealthDown","ChangeGuns"};
    ...
    void Start()
    {
        ...
        int i = 0;
        foreach (string power in listMisteryPower) {
            ...
            cube.transform.position = new Vector3(-10f, 2f, -8f+2*i);
            cube.GetComponent<Renderer>().material = materialForMisteryBoxes[0];
            cube.tag = "MisteryBox";
